<template functional>
	<div class="wrapper">
		<div class="tos">
			<h1>Cookie Policy for eerc.info</h1>

			<p>This is the Cookie Policy for eerc.info, accessible from http://eerc.info</p>
			...
			<p>
				...
				>Cookies Policy Template Generator</a> and the
				<a href="https://www.termsandcondiitionssample.com">Terms and Conditions Template</a>.
			</p>

			<p>However if you are still looking for more information then you can contact us through email:</p>

			<p>
				<a href="mailto:eerc.contact@gmail.com?Subject=TOS%20Help">eerc.contact@gmail.com</a>
			</p>
		</div>
	</div>
</template>
...
a {
	...
	font-weight: bold;
	font-style: italic;
	background: url(/img/svg/externLink.svg) no-repeat right center;
	padding-right: 25px;
}
a:hover {
